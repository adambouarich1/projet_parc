<div x-data="deleteConfirmation()" x-cloak>
    ...
    <div x-show="show"
        ...
        <div class="bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full border border-gray-700 overflow-hidden" @click.stop>
            <!-- Header -->
            <div class="p-6 flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-400 mt-1">Êtes-vous sûr de vouloir supprimer cet élément ?</p>
