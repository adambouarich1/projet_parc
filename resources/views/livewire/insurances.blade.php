...
<div class="space-y-5 text-gray-900 font-sans">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Assurances</h2>
            <p class="text-sm text-gray-700 mt-0.5">Vue d'ensemble de la couverture de votre flotte.</p>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 px-5 py-4 flex items-center gap-4">
            ...
            <div>
                <p class="text-xs font-bold text-gray-700 uppercase tracking-widest">Assurés</p>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 px-5 py-4 flex items-center gap-4">
            ...
            <div>
                <p class="text-xs font-bold text-gray-700 uppercase tracking-widest">Non assurés</p>
        ...
        <div class="lg:w-64 shrink-0 w-full">
            <div class="bg-white rounded-xl p-5 border border-gray-200 shadow-sm sticky top-4">
                ...
                <div class="mt-5 pt-4 border-t border-gray-200">
                    <p class="text-xs font-bold text-gray-700 uppercase tracking-widest mb-1">Coût total actif</p>
            ...
            <div>
                ...
                <div class="flex items-center gap-3 mb-3">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="text-lg font-bold text-gray-900">Véhicules non assurés</h3>
                    </div>
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        @else
                                            <p class="text-xs text-gray-700 mt-1">Aucune assurance enregistrée</p>
                                        @endif
                                    </div>
                                </div>
            ...
            <div>
                ...
                <div class="flex items-center gap-3 mb-3">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="text-lg font-bold text-gray-900">Véhicules assurés</h3>
                    </div>
                        ...
                        <div class="pl-5 pr-5 py-5">
                            ...
                            <div class="flex items-center gap-3 mb-4" style="font-size:18px;">
                                <div class="flex items-center gap-1.5 text-gray-800">
                                    <svg class="w-4 h-4 text-gray-700 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                                    <span class="text-gray-800">{{ $assurance->assureur }}</span>
                                </div>
                                @if($assurance->numero_police)
                                <span class="text-gray-700">·</span>
                                <span class="text-gray-800">Police <span class="text-gray-800 font-medium">{{ $assurance->numero_police }}</span></span>
                                @endif
                            </div>
                                ...
                                <div class="flex flex-1 gap-3">
                                    ...
                                    <div class="flex-1 flex items-center gap-3 bg-gray-50 rounded-xl px-4 py-3 border border-gray-200">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-800 mt-0.5" style="font-size:14px;">Exp. {{ $assurance->date_expiration->format('d/m/Y') }}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex-1 flex items-center gap-3 bg-gray-50 rounded-xl px-4 py-3 border border-gray-200">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-800 mt-0.5" style="font-size:14px;">{{ $assurance->duree_label }}</p>
                                        </div>
                                    </div>
                ...
                <div class="flex flex-col items-center justify-center py-16 bg-gray-50 rounded-2xl border border-gray-200">
                    ...
                    <p class="text-base font-semibold text-gray-800">Aucun véhicule assuré trouvé.</p>
                    <p class="text-sm mt-1 text-gray-800">Modifiez vos filtres ou enregistrez une nouvelle assurance.</p>
                </div>
                @endif
            </div>
            @endif
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6" x-data x-transition.opacity>
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full border border-gray-200/80 relative z-10 flex flex-col max-h-[90vh]">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200/60 shrink-0">
                <h3 class="text-lg font-bold text-gray-900">{{ $editingId ? 'Modifier l\'assurance' : 'Nouvelle assurance' }}</h3>
            ...
            <div class="overflow-y-auto p-6 custom-scrollbar">
                <form wire:submit.prevent="save" class="space-y-5" id="insurance-form">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-1.5">
                            <label class="text-xs font-semibold text-gray-800">Assureur <span class="text-rose-500">*</span></label>
                            <input type="text" wire:model="form.assureur" class="w-full rounded-lg border border-gray-300 bg-white text-gray-900 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all placeholder-gray-600" placeholder="Ex: Wafa Assurance, AXA...">
                            @error('form.assureur') <p class="text-xs text-rose-400 mt-1">{{ $message }}</p> @enderror
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-xs font-semibold text-gray-800">N° Police</label>
                            <input type="text" wire:model="form.numero_police" class="w-full rounded-lg border border-gray-300 bg-white text-gray-900 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all placeholder-gray-600" placeholder="Ex: POL-123456">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="space-y-1.5">
                            <label class="text-xs font-semibold text-gray-800">Durée <span class="text-rose-500">*</span></label>
                            <select wire:model="form.duree_mois" class="w-full rounded-lg border border-gray-300 bg-white text-gray-900 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all">
                    ...
                    <div class="flex items-center gap-2 bg-green-700/10 border border-indigo-500/20 rounded-lg px-4 py-3">
                        ...
                        <p class="text-xs text-green-700">La date d'expiration sera calculée automatiquement (date début + durée).</p>
                    </div>
 
                    {{-- Montant + Statut --}}
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-1.5">
                            <label class="text-xs font-semibold text-gray-800">Montant (DH)</label>
            ...
            <div class="flex justify-end gap-3 px-6 py-4 border-t border-gray-200/60 bg-gray-50 shrink-0 rounded-b-2xl">
                ...
                <button type="submit" form="insurance-form" class="px-5 py-2 text-sm font-semibold rounded-lg bg-green-700 text-white hover:bg-green-700 shadow-lg shadow-green-500/20 transition-all">
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full border border-gray-200/80 relative z-10 flex flex-col max-h-[90vh]">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200/60 shrink-0">
                <div class="flex items-center gap-3">
                    <h3 class="text-lg font-bold text-gray-900">Détails assurance</h3>
            ...
            <div class="overflow-y-auto p-6 space-y-4 custom-scrollbar">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="bg-white rounded-xl p-4 border border-gray-200 flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-gray-900">{{ $detailInsurance->vehicle->marque }} {{ $detailInsurance->vehicle->modele }}</p>
                            <p class="text-sm text-gray-700">{{ $detailInsurance->vehicle->immatriculation }}</p>
                        </div>
                    </div>
                    <div class="bg-white rounded-xl p-4 border border-gray-200 flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-[10px] font-bold text-gray-700 uppercase tracking-widest mb-0.5">Assureur</p>
                            <p class="font-semibold text-gray-900">{{ $detailInsurance->assureur }}</p>
                            @if($detailInsurance->numero_police)
                                <p class="text-sm text-gray-700">N° {{ $detailInsurance->numero_police }}</p>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div class="bg-green-700/10 rounded-xl p-4 border border-indigo-500/20 text-center">
                        <p class="text-[10px] font-bold text-green-700 uppercase tracking-widest mb-1">Durée</p>
                        <p class="font-bold text-green-700 text-xl">{{ $detailInsurance->duree_label }}</p>
                    </div>
                ...
                <div class="bg-white rounded-xl p-4 border border-gray-200">
                    ...
                    <p class="text-gray-800 text-sm">{{ $detailInsurance->observations }}</p>
                </div>
                @endif
                ...
                <div class="flex items-center gap-3 pt-1">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-semibold text-gray-200">{{ $detailInsurance->user->name }} <span class="text-gray-700 font-normal">le {{ $detailInsurance->created_at->format('d/m/Y H:i') }}</span></p>
                    </div>
                </div>
