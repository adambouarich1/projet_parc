<?php
    ...
    $typeColors = [
        ...
        'reparation' => 'bg-orange-50 text-orange-700 border-orange-200',
        'controle_technique' => 'bg-purple-500/15 text-purple-300 border-purple-500/30',
        'autre' => 'bg-gray-500/15 text-gray-800 border-gray-500/30',
    ];
    ...
    $typeIcons = [
        ...
        'autre' => 'text-gray-800 bg-gray-500/15 border-gray-500/20',
    ];
...
<div class="space-y-5 text-gray-900 font-sans">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Interventions</h2>
            <p class="text-sm text-gray-700 mt-0.5">Entretiens, réparations et contrôles techniques de votre flotte.</p>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div class="bg-white rounded-2xl border border-gray-200 px-5 py-4 flex items-center gap-4">
            ...
            <div>
                <p class="text-xs font-bold text-gray-700 uppercase tracking-widest">Coût total</p>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 px-5 py-4 flex items-center gap-4">
            ...
            <div>
                <p class="text-xs font-bold text-gray-700 uppercase tracking-widest">Total interventions</p>
                <p class="font-bold text-green-700 mt-0.5" style="font-size:23px;">{{ $stats['nb_interventions'] }}</p>
            </div>
        </div>
        <div class="bg-white rounded-2xl border border-gray-200 px-5 py-4 flex items-center gap-4">
            ...
            <div>
                <p class="text-xs font-bold text-gray-700 uppercase tracking-widest">Planifiées</p>
        ...
        <div class="lg:w-64 shrink-0 w-full">
            <div class="bg-white rounded-xl p-5 border border-gray-200 shadow-sm sticky top-4">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="text-xs font-semibold text-gray-700 block mb-1.5">Type</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-gray-700 block mb-1.5">Statut</label>
        ...
        <div class="flex-1 min-w-0 space-y-3">
            ...
            <div wire:key="intervention-{{ $intervention->id }}"
                ...
                <div class="pl-5 pr-5 py-5">
                    ...
                    <div class="flex flex-wrap items-center gap-3 mb-2">
                        <span class="font-mono font-bold bg-gray-700/60 text-gray-200 px-3 py-1 rounded-md border border-gray-300 shrink-0 leading-tight" style="font-size:23px;">
                    ...
                    <div class="flex items-center gap-3 mb-4" style="font-size:18px;">
                        ...
                        @if($intervention->prestataire)
                            ...
                            <span class="text-gray-800">{{ $intervention->prestataire }}</span>
                        @endif
                        @if($intervention->numero_facture)
                            <span class="text-gray-800">·</span>
                            <span class="text-gray-700">Fact. <span class="text-gray-800">{{ $intervention->numero_facture }}</span></span>
                        @endif
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch gap-3">
                        ...
                        <div class="flex flex-1 gap-3">
                            ...
                            <div class="flex-1 flex items-center gap-3 bg-gray-50 rounded-xl px-4 py-3 border border-gray-200">
                                ...
                                <div>
                                    <p class="font-bold uppercase tracking-widest leading-none mb-1.5 {{ $intervention->type === 'entretien' ? 'text-blue-400' : ($intervention->type === 'reparation' ? 'text-orange-400' : ($intervention->type === 'controle_technique' ? 'text-purple-400' : 'text-gray-800')) }}" style="font-size:18px;">Véhicule</p>
                                    <p class="font-bold text-gray-900 leading-tight" style="font-size:23px;">{{ $intervention->vehicle->marque }} {{ $intervention->vehicle->modele }}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex-1 flex items-center gap-3 bg-gray-50 rounded-xl px-4 py-3 border border-gray-200">
                                ...
                                <div>
                                    ...
                                    @if($intervention->date_prochaine)
                                        <p class="font-bold text-gray-900 leading-tight" style="font-size:23px;">{{ $intervention->date_prochaine->format('d/m/Y') }}</p>
                                    @else
                                        <p class="text-gray-800 font-semibold" style="font-size:23px;">—</p>
                                    @endif
                                </div>
                            </div>
            ...
            @empty
                <div class="flex flex-col items-center justify-center py-16 bg-gray-50 rounded-2xl border border-gray-200">
                    ...
                    <p class="text-base font-semibold text-gray-800">Aucune intervention trouvée.</p>
                    <p class="text-sm mt-1 text-gray-800">Modifiez vos filtres ou créez une nouvelle intervention.</p>
                </div>
            @endforelse
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6" x-data x-transition.opacity>
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-3xl w-full border border-gray-200/80 relative z-10 flex flex-col max-h-[90vh]">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200/60 shrink-0">
                <h3 class="text-lg font-bold text-gray-900">{{ $editingId ? 'Modifier l\'intervention' : 'Nouvelle intervention' }}</h3>
            ...
            <div class="overflow-y-auto p-6 custom-scrollbar">
                <form wire:submit.prevent="save" class="space-y-5" id="intervention-form">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="space-y-1.5">
                            <label class="text-xs font-semibold text-gray-800">Type <span class="text-rose-500">*</span></label>
                            <select wire:model.live="form.type" class="w-full rounded-lg border border-gray-300 bg-white text-gray-900 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all">
                                @foreach($types as $key => $label)
                                    <option value="{{ $key }}">{{ $label }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="space-y-1.5">
                        <label class="text-xs font-semibold text-gray-800">Titre <span class="text-rose-500">*</span></label>
                        <input type="text" wire:model="form.titre" class="w-full rounded-lg border border-gray-300 bg-white text-gray-900 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all placeholder-gray-600" placeholder="Ex: Vidange + filtres">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea wire:model="form.description" rows="2" class="w-full rounded-lg border border-gray-300 bg-white text-gray-900 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all placeholder-gray-600"></textarea>
                    </div>
 
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-1.5">
                            <label class="text-xs font-semibold text-gray-800">Date intervention <span class="text-rose-500">*</span></label>
                            <input type="date" wire:model="form.date_intervention" class="w-full rounded-lg border border-gray-300 bg-white text-gray-900 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all [&::-webkit-calendar-picker-indicator]:filter-invert">
                            @error('form.date_intervention') <p class="text-xs text-rose-400 mt-1">{{ $message }}</p> @enderror
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-xs font-semibold text-gray-800">Date prochaine intervention</label>
                            <input type="date" wire:model="form.date_prochaine" class="w-full rounded-lg border border-gray-300 bg-white text-gray-900 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all [&::-webkit-calendar-picker-indicator]:filter-invert">
                        </div>
                    </div>
 
                    <div class="space-y-1.5">
                        <label class="text-xs font-semibold text-gray-800">Coût de l'opération (DH)</label>
                        <input type="number" step="0.01" wire:model="form.cout_operation" class="w-full rounded-lg border border-gray-300 bg-white text-gray-900 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all" placeholder="Ex: 1500.00">
                        @error('form.cout_operation') <p class="text-xs text-rose-400 mt-1">{{ $message }}</p> @enderror
                    </div>
 
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-1.5">
                            <label class="text-xs font-semibold text-gray-800">Prestataire</label>
                            <input type="text" wire:model="form.prestataire" class="w-full rounded-lg border border-gray-300 bg-white text-gray-900 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all placeholder-gray-600" placeholder="Ex: Garage Central">
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-xs font-semibold text-gray-800">N° Facture</label>
                            <input type="text" wire:model="form.numero_facture" class="w-full rounded-lg border border-gray-300 bg-white text-gray-900 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all">
                        </div>
                    </div>
                    ...
                    <div class="bg-emerald-500/5 rounded-2xl p-5 border border-emerald-500/20 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <div class="space-y-1.5">
                                ...
                                <input type="text" wire:model="form.assureur" class="w-full rounded-lg border border-emerald-500/30 bg-gray-50 text-gray-900 text-sm focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all">
                            </div>
                            <div class="space-y-1.5">
                                <label class="text-xs font-semibold text-emerald-300">N° Police</label>
                                <input type="text" wire:model="form.numero_police" class="w-full rounded-lg border border-emerald-500/30 bg-gray-50 text-gray-900 text-sm focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all">
                            </div>
                            <div class="space-y-1.5">
                                <label class="text-xs font-semibold text-emerald-300">Date expiration</label>
                                <input type="date" wire:model="form.date_expiration_assurance" class="w-full rounded-lg border border-emerald-500/30 bg-gray-50 text-gray-900 text-sm focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all [&::-webkit-calendar-picker-indicator]:filter-invert">
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="bg-purple-500/5 rounded-2xl p-5 border border-purple-500/20 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div class="space-y-1.5">
                                ...
                                <select wire:model="form.resultat_ct" class="w-full rounded-lg border border-purple-500/30 bg-gray-50 text-gray-900 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all">
                                    <option value="">Sélectionner</option>
                            ...
                            <div class="space-y-1.5">
                                ...
                                <input type="date" wire:model="form.date_expiration_ct" class="w-full rounded-lg border border-purple-500/30 bg-gray-50 text-gray-900 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all [&::-webkit-calendar-picker-indicator]:filter-invert">
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea wire:model="form.observations" rows="2" class="w-full rounded-lg border border-gray-300 bg-white text-gray-900 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all placeholder-gray-600"></textarea>
                    </div>
            ...
            <div class="flex justify-end gap-3 px-6 py-4 border-t border-gray-200/60 bg-gray-50 shrink-0 rounded-b-2xl">
                ...
                <button type="submit" form="intervention-form" class="px-5 py-2 text-sm font-semibold rounded-lg bg-green-700 text-white hover:bg-green-700 shadow-lg shadow-green-500/20 transition-all">
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full border border-gray-200/80 relative z-10 flex flex-col max-h-[90vh]">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200/60 shrink-0">
                <div class="flex items-center gap-3 flex-wrap">
                    <h3 class="text-lg font-bold text-gray-900">{{ $detailIntervention->titre }}</h3>
                ...
                <button wire:click="$set('showDetailsModal', false)" class="text-gray-700 hover:text-gray-800 p-1.5 rounded-lg hover:bg-gray-50 transition-colors shrink-0">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
                </button>
            </div>
            <div class="overflow-y-auto p-6 space-y-4 custom-scrollbar">
                ...
                <div class="bg-white rounded-xl p-4 border border-gray-200 flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-900">{{ $detailIntervention->vehicle->marque }} {{ $detailIntervention->vehicle->modele }}</p>
                        <p class="text-sm text-gray-700">{{ $detailIntervention->vehicle->immatriculation }}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="bg-white rounded-xl p-4 border border-gray-200">
                        <p class="text-[10px] font-bold text-gray-700 uppercase tracking-widest mb-1">Date intervention</p>
                ...
                <div class="bg-emerald-500/5 rounded-2xl p-5 border border-emerald-500/20 space-y-3">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div><p class="text-[10px] text-gray-700 uppercase tracking-widest mb-0.5">Assureur</p><p class="text-sm font-semibold text-gray-200">{{ $detailIntervention->assureur }}</p></div>
                        <div><p class="text-[10px] text-gray-700 uppercase tracking-widest mb-0.5">N° Police</p><p class="text-sm font-semibold text-gray-200">{{ $detailIntervention->numero_police }}</p></div>
                        <div><p class="text-[10px] text-gray-700 uppercase tracking-widest mb-0.5">Expire le</p><p class="text-sm font-semibold text-emerald-300">{{ $detailIntervention->date_expiration_assurance?->format('d/m/Y') }}</p></div>
                    </div>
                </div>
                @endif
                ...
                <div class="bg-purple-500/5 rounded-2xl p-5 border border-purple-500/20 space-y-3">
                    <h4 class="text-xs font-bold text-purple-400 uppercase tracking-widest">Contrôle Technique</h4>
                    <div class="grid grid-cols-2 gap-4">
                        <div><p class="text-[10px] text-gray-700 uppercase tracking-widest mb-0.5">Résultat</p><p class="text-sm font-semibold text-purple-300">{{ $detailIntervention->resultat_ct_label }}</p></div>
                        <div><p class="text-[10px] text-gray-700 uppercase tracking-widest mb-0.5">Expire le</p><p class="text-sm font-semibold text-purple-300">{{ $detailIntervention->date_expiration_ct?->format('d/m/Y') }}</p></div>
                    </div>
                </div>
                @endif
                ...
                <div class="bg-white rounded-xl p-4 border border-gray-200">
                    ...
                    <p class="text-sm text-gray-800">{{ $detailIntervention->description }}</p>
                </div>
                @endif
                ...
                <div class="bg-white rounded-xl p-4 border border-gray-200">
                    ...
                    <p class="text-sm text-gray-800">{{ $detailIntervention->observations }}</p>
                </div>
                @endif
                ...
                <div class="flex items-center gap-3 pt-1">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-semibold text-gray-200">{{ $detailIntervention->user->name }} <span class="text-gray-700 font-normal">le {{ $detailIntervention->created_at->format('d/m/Y H:i') }}</span></p>
                    </div>
                </div>
