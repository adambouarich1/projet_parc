                                ...
                                <td class="px-4 py-3 text-right">
                                    <div class="flex justify-end gap-2">
                                        @if(auth()->user()->canEdit())
                                            ...
                                            <button 
                                                wire:click="deletePermanently('mission', {{ $item->id }})" 
                                                wire:confirm="Supprimer définitivement cet ordre de mission ?"
                                ...
                                <td class="px-4 py-3 text-right">
                                    <div class="flex justify-end gap-2">
                                        @if(auth()->user()->canEdit())
                                            ...
                                            <button 
                                                wire:click="deletePermanently('carburant', {{ $item->id }})" 
                                                wire:confirm="Supprimer définitivement cette entrée carburant ?"
                                                class="text-rose-400 hover:text-rose-300 text-sm" 
                                                title="Supprimer définitivement"
                                            >
                                                🗑️
                                ...
                                <td class="px-4 py-3 text-right">
                                    <div class="flex justify-end gap-2">
                                        @if(auth()->user()->canEdit())
                                            ...
                                            <button 
                                                wire:click="deletePermanently('intervention', {{ $item->id }})" 
                                                wire:confirm="Supprimer définitivement cette intervention ?"
                                                class="text-rose-400 hover:text-rose-300 text-sm" 
                                                title="Supprimer définitivement"
                                            >
                                                🗑️
                                ...
                                <td class="px-4 py-3 text-right">
                                    <div class="flex justify-end gap-2">
                                        @if(auth()->user()->canEdit())
                                            ...
                                            <button 
                                                wire:click="deletePermanently('assurance', {{ $item->id }})" 
                                                wire:confirm="Supprimer définitivement cette assurance ?"
                                                class="text-rose-400 hover:text-rose-300 text-sm" 
                                                title="Supprimer définitivement"
                                            >
                                                🗑️
                                ...
                                <td class="px-4 py-3 text-right">
                                    <div class="flex justify-end gap-2">
                                        @if(auth()->user()->canEdit())
                                            ...
                                            <button 
                                                wire:click="deletePermanently('alerte', {{ $item->id }})" 
                                                wire:confirm="Supprimer définitivement cette alerte ?"
                                                class="text-rose-400 hover:text-rose-300 text-sm" 
                                                title="Supprimer définitivement"
                                            >
                                                🗑️
